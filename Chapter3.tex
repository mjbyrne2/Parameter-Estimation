...
%In contrast, $\bm{\nu} \sim \mathcal{N}(P^\trans\zeroVec,P^\trans \Sigma P) = \mathcal{N}(\zeroVec,P^\trans \Sigma P)$; here the second zero vector $\zeroVec$ has dimension $r \times 1$. Since the columns of $P$ belonging in the columns space of $\Sigma$ are orthonormal, $\det(P^\trans \Sigma P) = \pdet(\Sigma) \neq 0$. Therefore $P^\trans \Sigma P$ is nonsingular, and so the probability density function of $\bm{\nu}$ is
%\begin{equation}
%\label{eq:Nu density}
