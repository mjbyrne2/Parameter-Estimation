...
The values of $c$ that were considered were 50 and 100, while the number of windows were chosen to be $p = 1,2,3$. As for the window types, we considered linear and linear Cosine windows to compare non-overlapping and overlapping windows. Noise was added to the blurred images with SNR's of 10, 25, and 40. Lastly, two penalty matrices were considered: the identity matrix (corresponding to standard Tikhonov regularization) and the negative discrete Laplacian.
