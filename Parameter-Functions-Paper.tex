...
\begin{enumerate}
    ...
    \end{enumerate}
\end{enumerate}
As a remark about part \ref{prop:Zero Pseudoinverse} of Proposition \ref{prop:Special pseudoinverses}, any matrix other than $\zeroVec_{n \times m}$ would fail to satisfy \ref{MP Condition 2} of the Moore-Penrose conditions.
\end{proof}
